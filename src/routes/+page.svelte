<script>
  ...
  let data = {
    ...
    skills: [ 'Svelte', 'React', 'Nodejs', 'PHP', 'Typescript', 'MongoDB', 'TailwindCSS', 'Bootstrap', 'PostgreSQL', 'Deno'],
...
<div class="flex bg-gray-200 flex-col">
  ...
  <div class="flex">
    <Main overview={data.overview} experiences={data.experiences} projects={data.projects} />
